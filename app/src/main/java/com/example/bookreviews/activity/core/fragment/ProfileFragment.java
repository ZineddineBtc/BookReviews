...
import com.example.bookreviews.activity.core.MyReviewsActivity;
import com.example.bookreviews.activity.entry.LoginActivity;
...
public class ProfileFragment extends Fragment {
    ...
    private void findViewsByIds(){
        ...
        reviewsLL = fragmentView.findViewById(R.id.reviewsLL);
    }
    ...
    private void setListeners(){
        ...
        reviewsLL.setOnClickListener(new View.OnClickListener() {
            @Override public void onClick(View v) { startActivity(new Intent(context, MyReviewsActivity.class)); }});
